...
def connect_regions(state: CollectionState, world: SDWorld) -> None:
    world.connect_2way(world.get_region("GeoRoom"), world.get_region("Hub1"), lambda state: sd_party_size_meets(state, world, 1))
    ...
    world.connect_2way(world.get_region("Hub2"), world.get_region("QuoDefenderRoom"), lambda state: sd_has_yellow(state, world))
    world.connect_2way(world.get_region("QuoDefenderRoom"), world.get_region("Red1"), lambda state: sd_can_fight_miniboss(state, world))
    ...
    world.connect_2way(world.get_region("Red1"), world.get_region("RedBackdoorIsland"), lambda state: sd_has_red(state, world))



    #Blue Zone!
    world.connect_2way(world.get_region("Hub2"), world.get_region("Blue1"), lambda state: sd_has_red(state, world))
    #You need two party members to pass the first Blue Bridge.
    world.connect_2way(world.get_region("Blue1"), world.get_region("Blue2"), lambda state: sd_party_size_meets(state, world, 2))
    world.connect_2way(world.get_region("Blue2"), world.get_region("Griffin1Room"), lambda state: sd_party_size_meets(state, world, 1))
    ...
    world.connect_2way(world.get_region("Griffin1Room"), world.get_region("BlueShaneArea"), lambda state: sd_can_fight_miniboss(state, world))
    #You can also technically skip Griffin by hopping the 3-long bridge.
    world.connect_2way(world.get_region("Blue2"), world.get_region("BlueShaneArea"), lambda state: sd_party_size_meets(state, world,3))
    #Adding the digger room, but it's not necessary because it blocks no paths.
    world.connect_2way(world.get_region("BlueShaneArea"), world.get_region("DiggerRoom"), lambda state: sd_party_size_meets(state, world,1))
    #To proceed, you now need three party members.
    world.connect_2way(world.get_region("BlueShaneArea"), world.get_region("Blue3"), lambda state: sd_party_size_meets(state, world,3))
    #To proceed, you now need four party members already!
    world.connect_2way(world.get_region("Blue3"), world.get_region("Blue4"), lambda state: sd_party_size_meets(state, world,4))
    #Let's start by going through the Wink side in Blue 4.
    #Back on track, confronting Scatter!
    world.connect_2way(world.get_region("Blue3"), world.get_region("Blue5"), lambda state: sd_party_size_meets(state, world,4))
    ...
    world.connect_2way(world.get_region("Blue3"), world.get_region("BlueBackdoorIsland"), lambda state: sd_has_blue(state, world))


    #Green Zone!
    #Don't forget the chest in Grey Zone on your way to Green1, it should be considered part of Green1
    world.connect_2way(world.get_region("Hub1"), world.get_region("Green1"), lambda state: sd_has_blue(state, world))
    world.connect_2way(world.get_region("Green1"), world.get_region("DesmodusRoom"), lambda state: sd_party_size_meets(state, world,1))
    world.connect_2way(world.get_region("DesmodusRoom"), world.get_region("Green2"), lambda state: sd_can_fight_miniboss(state, world))
    ...
    world.connect_2way(world.get_region("Purple1"), world.get_region("SwordmoleRoom"), lambda state: sd_party_size_meets(state, world,1))
    world.connect_2way(world.get_region("SwordmoleRoom"), world.get_region("Purple2"), lambda state: sd_can_fight_miniboss(state, world))
    world.connect_2way(world.get_region("Purple2"), world.get_region("ScaventureRoom"), lambda state: sd_party_size_meets(state, world,1))
    world.connect_2way(world.get_region("ScaventureRoom"), world.get_region("PurpleTower"), lambda state: sd_can_fight_miniboss(state, world))
    ...
    #On to Orange Zone!
    #Green Side First
    world.connect_2way(world.get_region("Hub2"), world.get_region("OngardRoom"), lambda state: sd_has_green(state, world))
    world.connect_2way(world.get_region("OngardRoom"), world.get_region("Hub3GreenSide"), lambda state: sd_can_fight_miniboss(state, world))
    world.connect_2way(world.get_region("Hub3GreenSide"), world.get_region("Orange1"), lambda state: sd_has_purple(state, world))
    ...
    world.connect_2way(world.get_region("Hub1"), world.get_region("Black1"), lambda state: sd_has_orange(state, world))
    world.connect_2way(world.get_region("Black1"), world.get_region("KisaijuRoom"), lambda state: sd_party_size_meets(state, world,1))
    world.connect_2way(world.get_region("KisaijuRoom"), world.get_region("Black2"), lambda state: sd_can_fight_miniboss(state, world))
    world.connect_2way(world.get_region("Black2"), world.get_region("Griffin2Room"), lambda state: sd_can_fight_miniboss(state, world))
    world.connect_2way(world.get_region("Griffin2Room"), world.get_region("BlackDungeon"), lambda state: sd_party_size_meets(state, world,1))

    #Here's the backdoor
    world.connect_2way(world.get_region("Black1"), world.get_region("BlackBackdoorIsland"), lambda state: sd_has_black(state, world))
    ...
    world.connect_2way(world.get_region("Yellow1"), world.get_region("EsquireRoom"), lambda state: sd_can_fight_miniboss(state, world))
    world.connect_2way(world.get_region("EsquireRoom"), world.get_region("Yellow2"),lambda state:  sd_party_size_meets(state, world,1))
    world.connect_2way(world.get_region("Yellow2"), world.get_region("MothershipRoom"), lambda state: sd_party_size_meets(state, world,1))
    world.connect_2way(world.get_region("MothershipRoom"), world.get_region("YellowLighthouse"), lambda state: sd_can_fight_miniboss(state, world))
    ...
    world.connect_2way(world.get_region("FinalLobby"), world.get_region("ExanderZone"), lambda state: sd_has_black(state, world) and sd_party_size_meets(state, world, 7))

    world.connect_2way(world.get_region("FinalLobby"), world.get_region("OmniZone1"), lambda state: sd_party_size_meets(state, world, 1))
    world.connect_2way(world.get_region("OmniZone1"), world.get_region("OmniZone2"), lambda state:  sd_has_dragon(state, world))
    world.connect_2way(world.get_region("OmniZone2"), world.get_region("OmniZone3"), lambda state: sd_has_kappa(state, world))
    world.connect_2way(world.get_region("OmniZone3"), world.get_region("OmniZone4"), lambda state: sd_has_cyclops(state, world))
    world.connect_2way(world.get_region("OmniZone4"), world.get_region("OmniZone5"), lambda state: sd_has_unicorn(state, world))
    world.connect_2way(world.get_region("OmniZone5"), world.get_region("OmniZone6"), lambda state: sd_has_phoenix(state, world))
    world.connect_2way(world.get_region("OmniZone6"), world.get_region("OmniZone7"), lambda state: sd_has_pulgasari(state, world))
    world.connect_2way(world.get_region("OmniZone7"), world.get_region("OmniRoom"), lambda state: sd_has_pixie(state, world))
    ...
    if world.options.shops:
        ...
        world.connect_2way(world.get_region("Shop"), world.get_region("Shop1"),lambda state: sd_party_size_meets(state, world, 1))
        world.connect_2way(world.get_region("Shop"), world.get_region("Shop2"),lambda state: sd_party_size_meets(state, world, 2))
        world.connect_2way(world.get_region("Shop"), world.get_region("Shop3"),lambda state: sd_party_size_meets(state, world, 3))
        world.connect_2way(world.get_region("Shop"), world.get_region("Shop4"),lambda state: sd_party_size_meets(state, world, 4))
        world.connect_2way(world.get_region("Shop"), world.get_region("Shop5"),lambda state: sd_party_size_meets(state, world, 5))
        world.connect_2way(world.get_region("Shop"), world.get_region("Shop6"),lambda state: sd_party_size_meets(state, world, 6))
        world.connect_2way(world.get_region("Shop"), world.get_region("Shop7"),lambda state: sd_party_size_meets(state, world, 7))

    if world.options.recollections:
        world.connect_2way(world.get_region("Blue4"), world.get_region("ReCollectionBlue"), lambda state: sd_has_reco(state, world, 5))
        world.connect_2way(world.get_region("Green1"), world.get_region("ReCollectionGreen"),lambda state: sd_has_reco(state, world, 3))
        world.connect_2way(world.get_region("PurpleTower"), world.get_region("ReCollectionPurple"), lambda state: sd_has_reco(state, world, 4) and sd_can_status_stun(state, world))
        world.connect_2way(world.get_region("Orange2"), world.get_region("ReCollectionOrange"),lambda state: sd_has_reco(state, world, 7) and sd_can_status_depression(state, world))
        world.connect_2way(world.get_region("Griffin2Room"), world.get_region("ReCollectionBlack"),lambda state: sd_has_reco(state, world, 1))
        world.connect_2way(world.get_region("YellowLighthouse"), world.get_region("ReCollectionYellow"),lambda state: sd_has_yellow(state, world) and sd_has_reco(state, world, 6))
        world.connect_2way(world.get_region("Red2"), world.get_region("ReCollectionRed"), lambda state: sd_has_reco(state, world, 2))
        world.connect_2way(world.get_region("Hub2"), world.get_region("ReCollectionGrey"),lambda state: sd_has_reco(state, world, 8))
        world.connect_2way(world.get_region("FinalLobby"), world.get_region("ReCollectionWhite"), lambda state: sd_has_reco10(state, world) and sd_can_use_all_colors(state, world))
        world.connect_2way(world.get_region("ExanderZone"), world.get_region("ReCollectionExander"),lambda state: sd_has_reco(state, world, 9))
    ...
    if world.options.minibosses:
        ...
        world.connect_2way(world.get_region("KingooseRoom"), world.get_region("KingooseItems"),lambda state:  sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("Griffin1Room"), world.get_region("Griffin1Items"),lambda state:  sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("DiggerRoom"), world.get_region("DiggerItems"), lambda state: sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("DesmodusRoom"), world.get_region("DesmodusItems"), lambda state: sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("SquailArea"), world.get_region("SquailItems"), lambda state: sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("SwordmoleRoom"), world.get_region("SwordmoleItems"), lambda state: sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("ScaventureRoom"), world.get_region("ScaventureItems"),lambda state:  sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("OngardRoom"), world.get_region("OngardItems"), lambda state: sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("DualistsRoom"), world.get_region("DualistsItems"), lambda state: sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("KisaijuRoom"), world.get_region("KisaijuItems"), lambda state: sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("Griffin2Room"), world.get_region("Griffin2Items"), lambda state: sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("EsquireRoom"), world.get_region("EsquireItems"), lambda state: sd_can_fight_miniboss(state, world))
        world.connect_2way(world.get_region("MothershipRoom"), world.get_region("MothershipItems"), lambda state: sd_can_fight_miniboss(state, world))

    if world.options.wardens:
        world.connect_2way(world.get_region("Red2"), world.get_region("NyxItems"), lambda state: sd_can_fight_warden(state, world))
        world.connect_2way(world.get_region("ScatterRoom"), world.get_region("ScatterItems"), lambda state: sd_can_fight_warden(state, world))
        world.connect_2way(world.get_region("Green2"), world.get_region("CyphonItems"), lambda state: sd_can_fight_warden(state, world))
        world.connect_2way(world.get_region("PurpleTower"), world.get_region("EnriItems"), lambda state: sd_can_fight_warden(state, world))
        world.connect_2way(world.get_region("Orange1"), world.get_region("RudaItems"), lambda state: sd_can_fight_warden(state, world))
        world.connect_2way(world.get_region("BlackDungeon"), world.get_region("RotItems"), lambda state: sd_can_fight_warden(state, world))
        world.connect_2way(world.get_region("YellowLighthouse"), world.get_region("WinkItems"), lambda state: sd_can_fight_warden(state, world))
        world.connect_2way(world.get_region("ExanderZone"), world.get_region("FinalGriffinItems"), lambda state: sd_can_fight_warden(state, world))

    if world.options.chaoswardens:
        world.connect_2way(world.get_region("PurpleHippoRoom"), world.get_region("PurpleHippoItems"), lambda state: sd_can_fight_warden(state, world))
        world.connect_2way(world.get_region("RedBackdoorIsland"), world.get_region("ChaosRotItems"), lambda state: sd_can_fight_chaos_warden(state, world))
        world.connect_2way(world.get_region("PurpleBackdoorIsland"), world.get_region("ChaosRudaItems"), lambda state: sd_can_fight_chaos_warden(state, world))
        world.connect_2way(world.get_region("BlueBackdoorIsland"), world.get_region("ChaosNyxItems"), lambda state: sd_can_fight_chaos_warden(state, world))
        world.connect_2way(world.get_region("OrangeBackdoorIsland"), world.get_region("ChaosCyphonItems"), lambda state: sd_can_fight_chaos_warden(state, world))
        world.connect_2way(world.get_region("YellowBackdoorIsland"), world.get_region("ChaosEnriItems"), lambda state: sd_can_fight_chaos_warden(state, world))
